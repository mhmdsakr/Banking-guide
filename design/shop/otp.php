...
<body> 
    ...
    <div class="container">
      <div class="col-sm-8 offset-sm-2 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3 text-center">
        ...
        <form action="functions/shop/confirmOTP.php" method="POST" class="rounded bg-white shadow p-5">
          ...
          <button type="submit" class="btn btn-primary submit_btn my-4">Submit</button> 
            ...
            Didn’t get the code ? <a href="fun/send_otp.php" class="text-primary fw-bold text-decoration-none">Resend</a>
          </div>
          <div>
          <?php
